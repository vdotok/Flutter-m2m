...
const createGroupColor = Color(0xFFEEDF4C);
...
//  No COnversation Screen WEB ///
const logoBckgroundColor = Color(0xffF2F3F4);
const chatRoomwebColor = Color(0xff74A59C);

//  WEBCOLORS//
const norgicTalkColor = Color(0xff31394d);
const creatrURLColor = Color(0xff29b37b);
